...
const Hero = () => {
  ...
  return (
    <div
      id="hero"
      className="bg-white min-h-screen py-16 px-6 md:px-0 text-gray-800"
    >
      <section className="flex flex-col md:flex-row items-center justify-between bg-grey py-16 px-6 md:px-10 relative overflow-hidden">
        <div className="max-w-lg z-10">
          ...
          <p className="text-gray-700 text-lg mb-6">
            ...
            <span className="text-2xl font-extrabold text-blue-900 mb-4">
              We have 10 years of coding experience in London
            </span>
          </p>
        ...
        <div className="relative w-full md:w-[400px] h-[500px] mt-10 md:mt-0 rounded-2xl overflow-hidden shadow-[0_20px_10px_rgba(0,0,0,0.45)] hover:scale-105 transition-transform duration-200">
